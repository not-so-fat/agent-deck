...
export const HTTP_ROUTE_POLICIES: RoutePolicyRule[] = [
  ...
  { methods: ['POST'], pattern: /^\/api\/playbooks$/, policy: 'requireDashboard' },
  { methods: ['PUT'], pattern: /^\/api\/playbooks\/[^/]+$/, policy: 'requireDashboard' },
  { methods: ['DELETE'], pattern: /^\/api\/playbooks\/[^/]+$/, policy: 'requireDashboard' },
  { methods: ['PUT'], pattern: /^\/api\/services\/[^/]+\/tool-settings$/, policy: 'requireDashboard' },
