...
const ADMIN_SECRET_ENV = 'AGENT_DECK_ADMIN_SECRET';
...
export async function readAdminSecretFromEnvOrFile(): Promise<string | null> {
  const fromEnv = process.env[ADMIN_SECRET_ENV]?.trim();
